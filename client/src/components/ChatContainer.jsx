...
const ChatContainer = () => {
  ...
  const { authUser, onlineUsers = [] } = useContext(AuthContext); // Added fallback for online list
    ...
    <div className="h-full overflow-y-auto relative backdrop-blur-lg">
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        ...
        <div className="flex-1 text-lg text-white flex items-center gap-2">
          ...
          {/* Safely check online status via conditional rendering */}
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
        <form
          ...
          className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full"
        >
          <input
